...
#include "../protocolstack/netconfig.h"
#include "../protocolstack/messages.h"
...
extern send_params_t g_watcher_module_send_params;
extern void my_send(send_params_t& params);
...
#define MAX_IPPORT_STR_LEN 6 //65535
