...
typedef std::function<void(const sockaddrunion& source, geco_bit_stream_t& data)> msg_handler_t;
 ...
 */
class NubException;
typedef std::function<void(const sockaddrunion & source, geco_bit_stream_t& data, void* args)>
reply_msg_handler_t;
