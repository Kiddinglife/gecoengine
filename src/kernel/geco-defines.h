...
#ifndef __GECO_DEFINES_H__
#define __GECO_DEFINES_H__
...
#define GECO_API GECO_FAST_CALL
#define GECO_EXTERN_VAR 
#elif defined (WIN32)
#if defined(GECO_BUILD_DLL) || defined(GECO_EXPORT_DLL)
#define GECO_API GECO_Proper_Export_Flag GECO_FAST_CALL
#define GECO_EXTERN_VAR GECO_Proper_Export_Flag
#else 
#define GECO_API GECO_Proper_Import_Flag GECO_FAST_CALL
