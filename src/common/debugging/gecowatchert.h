...
namespace geco
{
	namespace debugging
	{
		...
		inline bool read_watcher_value_from_stream(geco_bit_stream_t & result, bool& value, uchar& valtype, uchar& mode, std::string& path, std::string& comment)
		{
		...
		inline bool read_watcher_value_from_stream(geco_bit_stream_t & result, int& value, uchar& valtype, uchar& mode, std::string& path, std::string& comment)
		{
			result.ReadMini(valtype);
			result.ReadMini(mode);
		...
		inline bool read_watcher_value_from_stream(geco_bit_stream_t & result, uint& value, uchar& valtype, uchar& mode, std::string& path, std::string& comment)
		{
			result.ReadMini(valtype);
			result.ReadMini(mode);
			result.ReadMini(value);
		...
		inline bool read_watcher_value_from_stream(geco_bit_stream_t & result, uint8& value, uchar& valtype, uchar& mode, std::string& path, std::string& comment)
		{
			result.ReadMini(valtype);
			result.ReadMini(mode);
			result.ReadMini(value);
		...
		inline bool read_watcher_value_from_stream(geco_bit_stream_t & result, int8& value, uchar& valtype, uchar& mode, std::string& path, std::string& comment)
		{
			result.ReadMini(valtype);
			result.ReadMini(mode);
			result.ReadMini(value, false);
		...
		inline bool read_watcher_value_from_stream(geco_bit_stream_t & result, uint16& value, uchar& valtype, uchar& mode, std::string& path, std::string& comment)
		{
			result.ReadMini(valtype);
			result.ReadMini(mode);
			result.ReadMini(value);
		...
		inline bool read_watcher_value_from_stream(geco_bit_stream_t & result, int16& value, uchar& valtype, uchar& mode, std::string& path, std::string& comment)
		{
			result.ReadMini(valtype);
			result.ReadMini(mode);
			result.ReadMini(value, false);
		...
		inline bool read_watcher_value_from_stream(geco_bit_stream_t & result, uint64& value, uchar& valtype, uchar& mode, std::string& path, std::string& comment)
		{
			result.ReadMini(valtype);
			result.ReadMini(mode);
			result.ReadMini(value);
		...
		inline bool read_watcher_value_from_stream(geco_bit_stream_t & result, int64& value, uchar& valtype, uchar& mode, std::string& path, std::string& comment)
		{
			result.ReadMini(valtype);
			result.ReadMini(mode);
			result.ReadMini(value, false);
		...
		inline bool read_watcher_value_from_stream(geco_bit_stream_t & result, double& value, uchar& valtype, uchar& mode, std::string& path, std::string& comment)
		{
			result.ReadMini(valtype);
			result.ReadMini(mode);
			result.Read(value);
		...
		inline bool read_watcher_value_from_stream(geco_bit_stream_t & result, float& value, uchar& valtype, uchar& mode, std::string& path, std::string& comment)
		{
			result.ReadMini(valtype);
			result.ReadMini(mode);
			result.Read(value);
		...
		inline bool read_watcher_value_from_stream(geco_bit_stream_t & result, uchar* value, uchar& valtype, uchar& mode, std::string& path, std::string& comment)
		{
			result.ReadMini(valtype);
			result.ReadMini(mode);
			uint bytes2Write;
		...
		inline bool read_watcher_value_from_stream(geco_bit_stream_t & result, char* value, uchar& valtype, uchar& mode, std::string& path, std::string& comment)
		{
			return read_watcher_value_from_stream(result, (uchar*)value, valtype, mode, path, comment);
		}
		inline bool read_watcher_value_from_stream(geco_bit_stream_t & result, std::string& value, uchar& valtype, uchar& mode, std::string& path, std::string& comment)
		{
			result.ReadMini(valtype);
			result.ReadMini(mode);
			uint bytes2Write;
		...
		public:
			...
			virtual bool set_from_stream(void * base, const char * path, watcher_path_request_v2& pathRequest)
			{
				...
				if (geco_watcher_director_t::is_empty_path(path) && (setMethod_ != NULL))
				{
					...
					comment.clear();
					RETURN_TYPE useValue;
					if (read_watcher_value_from_stream(pathRequest.get_value_stream(), useValue, valtype, mode, mypath, comment))
					{
						if (valtype != WT_DIRECTORY)
						{
							if (mode == WT_READ_WRITE)
							{
								...
								{
									// remove ptr of this watcher from dir but ptr is not freed at this moment
									geco_watcher_base_t::get_root_watcher().find_child(mypath.c_str())
								}
