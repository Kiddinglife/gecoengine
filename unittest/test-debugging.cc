...
static bool criticalcallback(int component_priority, int msg_priority, const char * format, va_list args_list)
{
...
TEST(GECO_DEBUGGING_MSGLOG, test_critical_msg)
{
    ...
    critical_msg_cb_t dcb = std::bind(criticalcallback, std::placeholders::_1, std::placeholders::_2,
...
static bool debugcallback(int component_priority, int msg_priority, const char * format, va_list args_list)
{
    // !!! never call debugging macro in debugging cb will loop DEBUG_MSG("DEBUG_MSG %d\n", 12);
...
{
    debug_msg_cb_t dcb = std::bind(debugcallback, std::placeholders::_1, std::placeholders::_2, std::placeholders::_3,
            std::placeholders::_4);
