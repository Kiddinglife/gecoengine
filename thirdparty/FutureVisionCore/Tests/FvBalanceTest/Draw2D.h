...
void DrawPoint(const FvVector2& pt, const p2Clr& clr=CLR_WHITE, float size=3.0f);
void DrawRect(const FvVector4& rt, const p2Clr& clr=CLR_WHITE);
void DrawCircle(const FvVector2& center, float radius, const p2Clr& color=CLR_WHITE);
