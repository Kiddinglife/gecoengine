...
#ifndef __FvClientEntityExportMacro_H__
#define __FvClientEntityExportMacro_H__
...
#define EXTERN_STRFUNC_HANDLER(_PREFIX, _NAME)	\
	class _NAME##_StrHandler;					\
	extern _PREFIX _NAME##_StrHandler g_k##_NAME##_StrHandler;


#define DEFINE_ENTITY_EXPORT_START(_PREFIX, _CLASS, _TYPE, _HAS_BASE, _HAS_CELL, _HAS_CLI, _MEMBER_CNT,	\
	...
	void _PREFIX EntityExport_of_##_CLASS(void*& pkEntityExport)								\
	{																							\
...
#define DEFINE_ENTITY_EXPORT_END	}


#define EXPORT_STRFUNC(_FUNC, _PROTOTYPE, _HANDLER)	\
	s_kExport.kStrFuncHandlerMap[_FUNC].push_back(std::make_pair(_PROTOTYPE, (FvCallFuncByStrHandler*)(&g_k##_HANDLER##_StrHandler)));



#endif//__FvClientEntityExportMacro_H__
