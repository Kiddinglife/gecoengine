...
FvZoneCache::Instance<FvZoneAnimationModelObstacle> FvZoneAnimationModelObstacle::ms_kInstance;

FvZoneAnimationModelObstacle::FvZoneAnimationModelObstacle(FvZone& kZone)
:m_pkZone( &kZone )
{
...
//----------------------------------------------------------------------------
FvZoneAnimationModelObstacle::~FvZoneAnimationModelObstacle()
{
	//FV_GUARD;
...
//----------------------------------------------------------------------------
int FvZoneAnimationModelObstacle::Focus()
{
	//FV_GUARD;
	int iFoco = 0;
...
//----------------------------------------------------------------------------
void FvZoneAnimationModelObstacle::AddObstacle( FvZoneObstacle *pkObstacle )
{
	//FV_GUARD;
...
//----------------------------------------------------------------------------
void FvZoneAnimationModelObstacle::DelObstacles( FvZoneItemPtr spItem )
{
	//FV_GUARD;
...
//----------------------------------------------------------------------------
void FvZoneAnimationModelObstacle::AddAnimationModel(FvSmartPointer<FvAnimationModel> spAnimModel,
								 const FvMatrix &kWorld, FvZoneItemPtr spItem, bool bEditorProxy)
{
	//FV_GUARD;
	if (spAnimModel == NULL || spItem == NULL)
		return;

	const FvBSPTree *pkBSPTree = spAnimModel->GetBSPTree();
	...
	if (pkBSPTree != NULL)
	{
		...
		this->AddObstacle( new FvZoneBSPObstacle(
			*pkBSPTree, kWorld, &spAnimModel->BoundingBox(), spItem ) );
	}
}
//----------------------------------------------------------------------------
int FvZoneAnimationModelObstacle::AddToSpace(FvZoneObstacle &kCSO)
{
	//FV_GUARD;
	int iFoco = 0;
...
//----------------------------------------------------------------------------
void FvZoneAnimationModelObstacle::DelFromSpace(FvZoneObstacle &kCSO)
{
	//FV_GUARD;
	ColumnSet kColumns;
