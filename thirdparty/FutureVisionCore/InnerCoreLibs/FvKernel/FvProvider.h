...
public:
	...
	const T& GetData0()const {FV_ASSERT(m_pkPointer0);return *m_pkPointer0;}
	void Attach0(const T& kCache){m_pkPointer0 = &kCache;}
	void Detach0(){FV_ASSERT(m_pkPointer0);m_kCache0 = (*m_pkPointer0);m_pkPointer0 = &m_kCache0;}
	void Detach(){Detach0();}
...
public:
	...
	const T& GetData0()const{FV_ASSERT(m_pkPointer0);return *m_pkPointer0;}
	const U& GetData1()const{FV_ASSERT(m_pkPointer1);return *m_pkPointer1;}
	void Attach0(const T& kCache){m_pkPointer0 = &kCache;}
	void Attach1(const U& kCache){m_pkPointer1 = &kCache;}
	void Detach0(){FV_ASSERT(m_pkPointer0);m_kCache0 = (*m_pkPointer0);m_pkPointer0 = &m_kCache0;}
	void Detach1(){FV_ASSERT(m_pkPointer1);m_kCache1 = (*m_pkPointer1);m_pkPointer1 = &m_kCache1;}
...
public:
	...
	const T& GetData0() const{FV_ASSERT(m_pkPointer0);return *m_pkPointer0;}
	const U& GetData1() const{FV_ASSERT(m_pkPointer1);return *m_pkPointer1;}
	const V& GetData2() const{FV_ASSERT(m_pkPointer2);return *m_pkPointer2;}
	void Attach0(const T& kCache){m_pkPointer0 = &kCache;}
	void Attach1(const U& kCache){m_pkPointer1 = &kCache;}
	void Attach2(const V& kCache){m_pkPointer2 = &kCache;}
	void Detach0(){FV_ASSERT(m_pkPointer0);m_kCache0 = (*m_pkPointer0);m_pkPointer0 = &m_kCache0;}
	void Detach1(){FV_ASSERT(m_pkPointer1);m_kCache1 = (*m_pkPointer1);m_pkPointer1 = &m_kCache1;}
	void Detach2(){FV_ASSERT(m_pkPointer2);m_kCache2 = (*m_pkPointer2);m_pkPointer2 = &m_kCache2;}
